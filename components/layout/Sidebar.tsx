...
export default function Sidebar({ role }: { role: AppRole }) {
  ...
  const content = <>
    ...
    </nav><p className="border-t border-white/10 px-6 py-4 text-xs leading-5 text-slate-300">Satu ruang untuk administrasi belajar.<br />Semua modul inti siap digunakan.</p>
  </>
